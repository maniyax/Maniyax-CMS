...
$config['smtp_username'] = site('smtplogin');
$config['smtp_port'] = site('smtpport');
$config['smtp_host'] =  'ssl://'.site('smtphost');
$config['smtp_password'] = site('smtppass');
$config['smtp_debug'] = true;
$config['smtp_charset'] = 'utf-8';
$config['smtp_from'] = site('smtpfrom');
